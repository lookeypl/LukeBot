...
namespace LukeBot.Services
{
     ...
     *
     * NOTE: DO NOT implement this Interface. Instead implement IService<>.
     *
    ...
    public interface IServiceBase
    {
         ...
         *
         * Name is mostly used for printing/debugging purposes.
         */
         ...
         *
         * NOTE: Service names most probably will NOT match what GetServiceDebugName() returns.
         *       For best compatibility, use Service.NameOf<>() and refer to a Service by its Type
         *       which will be the same as in Service.Get<>().
         *
         ...
         *
         * If there is a circular dependency between different Services, Service Manager will
