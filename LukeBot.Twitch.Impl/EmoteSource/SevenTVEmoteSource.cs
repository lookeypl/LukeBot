...
namespace LukeBot.Twitch.Impl
{
    ...
    class SevenTVEmoteSource: IEmoteSource
    {
        ...
        private void AddEmoteDataToSet(API.EmoteSet fetchedSet, ref Dictionary<string, Twitch.Emote> emoteSet)
        {
            foreach (var o in fetchedSet.emotes)
            {
                ...
                {
                    emoteSet.Add(o.name, new Twitch.Emote(EmoteSource.SevenTV, o.name, o.id, o.width, o.height, o.animated));
                }
            }
        }
